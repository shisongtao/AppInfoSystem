...
public class ManagerController {
	...
	public String appList(Model model,@RequestParam(value="querySoftwareName",required=false)String querySoftwareName,
		...
		//List<AppInfo> appInfoList = appInfoService.fiandAppInfoList(querySoftwareName, _queryFlatformId, _queryCategoryLevel1, _categorylevel2list, _queryCategoryLevel3, currentPageNo, pageSize);
